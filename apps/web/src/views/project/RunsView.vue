...
<style scoped>
.queue-summary { display:grid; grid-template-columns:repeat(5,minmax(0,1fr)); gap:.75rem; margin-bottom:1rem; }.queue-summary-card { display:grid; grid-template-columns:1.75rem 1fr; grid-template-rows:1.125rem 1rem; column-gap:.5625rem; padding:.75rem .8125rem; border:.0625rem solid var(--workspace-border); border-radius:.625rem; background:var(--surface); }.queue-summary-card > span { grid-row:1 / -1; display:grid; place-items:center; width:1.75rem; height:1.75rem; border-radius:.5rem; }.queue-summary-card strong { color:var(--workspace-text); font-size:1rem; line-height:1.1; }.queue-summary-card small { color:var(--workspace-muted); font-size: 0.75rem; }.queue-summary-running > span { color:#0c887a; background:#e1f7f3; }.queue-summary-queued > span { color:#6d7b85; background:#eef2f3; }.queue-summary-paused > span { color:#b7771d; background:#fff2dc; }.queue-summary-completed > span { color:#2f8b5e; background:#e7f7ee; }.queue-summary-failed > span { color:#b65b5b; background:#fff0f0; }
.queue-panel { overflow:hidden; }.queue-panel-heading { display:flex; align-items:flex-start; justify-content:space-between; gap:1rem; padding:1.125rem 1.25rem .875rem; border-bottom:.0625rem solid var(--workspace-divider); }.queue-panel-heading h2 { margin:0; color:var(--workspace-text); font-size:.875rem; }.queue-panel-heading p { margin:.3125rem 0 0; color:var(--workspace-muted); font-size: 0.75rem; }.queue-live-note { display:inline-flex; align-items:center; gap:.3125rem; color:var(--teal-dark); font-size: 0.75rem; white-space:nowrap; }.queue-live-note i { width:.375rem; height:.375rem; border-radius:50%; background:var(--teal); box-shadow:0 0 0 .1875rem #dcf6f1; }.queue-toolbar { display:flex; align-items:center; gap:.625rem; padding:.75rem 1.25rem; border-bottom:.0625rem solid var(--workspace-divider); background:var(--surface-soft); }.queue-search { display:flex; align-items:center; gap:.375rem; min-width:16rem; flex:1; padding:.4375rem .5625rem; border:.0625rem solid var(--workspace-border); border-radius:.4375rem; background:var(--surface); color:var(--workspace-subtle); }.queue-search input { width:100%; border:0; outline:0; color:var(--workspace-text); background:transparent; font:inherit; font-size: 0.75rem; }.queue-toolbar select { min-width:7.5rem; padding:.5rem .5625rem; border:.0625rem solid var(--workspace-border); border-radius:.4375rem; color:var(--workspace-muted); background:var(--surface); font:inherit; font-size: 0.75rem; }.queue-table-wrap { overflow-x:auto; }.queue-table { display:grid; grid-template-columns:minmax(17rem,1.75fr) 5.5rem minmax(12rem,1.35fr) 4.5rem 7.5rem 7.25rem; gap:.75rem; align-items:center; min-width:54rem; padding:0 1.25rem; }.queue-table-header { min-height:2.5rem; color:var(--workspace-subtle); border-bottom:.0625rem solid var(--workspace-divider); font-size: 0.75rem; }.queue-table-row { min-height:4.75rem; border-bottom:.0625rem solid var(--workspace-divider); }.queue-table-row:last-child { border-bottom:0; }.queue-task-cell { display:flex; align-items:center; min-width:0; gap:.5625rem; padding:0; border:0; background:transparent; text-align:left; cursor:pointer; }.queue-task-icon { display:grid; place-items:center; width:1.875rem; height:1.875rem; flex:0 0 auto; border-radius:.5625rem; }.queue-task-cell > span:last-child { display:grid; min-width:0; gap:.25rem; }.queue-task-cell strong,.queue-task-cell small { overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }.queue-task-cell strong { color:var(--workspace-text); font-size: 0.75rem; }.queue-task-cell small { color:var(--workspace-muted); font-size: 0.75rem; }.queue-status,.queue-priority { display:inline-flex; align-items:center; gap:.3125rem; font-size: 0.75rem; white-space:nowrap; }.queue-status i { width:.375rem; height:.375rem; border-radius:50%; background:currentColor; }.queue-status-running,.queue-status-completed { color:var(--teal-dark); }.queue-status-queued { color:#78868c; }.queue-status-paused { color:#b4771e; }.queue-status-failed,.queue-status-cancelled { color:#b65b5b; }.queue-progress-cell { min-width:0; }.queue-progress-top { display:flex; align-items:center; justify-content:space-between; gap:.375rem; margin-bottom:.3125rem; }.queue-progress-top strong { color:var(--teal-dark); font-size: 0.75rem; }.queue-progress-top small { overflow:hidden; color:var(--workspace-muted); font-size: 0.75rem; text-overflow:ellipsis; white-space:nowrap; }.queue-progress-track { height:.25rem; overflow:hidden; border-radius:999px; background:var(--workspace-divider); }.queue-progress-track i { display:block; height:100%; border-radius:inherit; background:var(--teal); transition:width .3s ease; }.queue-priority { justify-content:center; width:max-content; padding:.25rem .375rem; border-radius:.3125rem; }.priority-high { color:#b65b5b; background:#fff0f0; }.priority-normal { color:#75828a; background:#eef2f3; }.priority-low { color:#56836d; background:#eaf7ef; }.queue-time { display:grid; gap:.25rem; color:var(--workspace-muted); font-size: 0.75rem; }.queue-time small { color:var(--workspace-subtle); font-size: 0.75rem; }.queue-actions { display:flex; align-items:center; justify-content:flex-end; gap:.3125rem; }.queue-cancel-button:hover { color:#b65b5b; border-color:#e2b7b7; }.queue-status-running { background:#e1f7f3; color:#0c887a; }.queue-status-completed { background:#e7f7ee; color:#2f8b5e; }.queue-status-failed,.queue-status-cancelled { background:#fff0f0; color:#b65b5b; }.queue-status-queued { background:#eef2f3; color:#78868c; }.queue-status-paused { background:#fff2dc; color:#b7771e; }.queue-task-icon.queue-status-running,.queue-task-icon.queue-status-completed,.queue-task-icon.queue-status-failed,.queue-task-icon.queue-status-cancelled,.queue-task-icon.queue-status-queued,.queue-task-icon.queue-status-paused { background:color-mix(in oklab,currentColor 12%,var(--surface)); }.queue-empty { display:grid; justify-items:center; gap:.375rem; padding:3rem 1rem; color:var(--workspace-subtle); }.queue-empty strong { color:var(--workspace-muted); font-size: 0.8125rem; }.queue-empty span { font-size:0.75rem; }.queue-flow-card { display:flex; align-items:center; justify-content:space-between; gap:1rem; margin-top:1rem; padding:.875rem 1rem; border:.0625rem solid var(--workspace-border); border-radius:.625rem; background:linear-gradient(110deg,color-mix(in oklab,var(--teal) 6%,var(--surface)),var(--surface)); }.queue-flow-card > div:first-child { display:flex; align-items:flex-start; gap:.5625rem; }.queue-flow-icon { display:grid; place-items:center; width:1.875rem; height:1.875rem; flex:0 0 auto; border-radius:.5rem; color:var(--teal-dark); background:#e2f7f3; }.queue-flow-card strong,.queue-flow-card p { display:block; }.queue-flow-card strong { color:var(--workspace-text); font-size: 0.75rem; }.queue-flow-card p { max-width:34rem; margin:.25rem 0 0; color:var(--workspace-muted); font-size: 0.75rem; line-height:1.45; }.queue-flow-steps { display:flex; align-items:center; gap:.375rem; color:var(--teal-dark); font-size: 0.75rem; white-space:nowrap; }.queue-flow-steps b { color:var(--workspace-subtle); font-weight:400; }
