...
def evaluate_grounding(
    ...
    return GroundingMetrics(
        ...
        round(precision, 4),
        round(recall, 4),
        not (referenced - valid),
    )


def evaluate_prompt_case(
    case: PromptEvalCase, output: dict[str, Any], valid_evidence_ids: set[str]
) -> dict[str, Any]:
    ...
    return {
        ...
        "citationPrecision": metrics.citation_precision,
        "citationRecall": metrics.citation_recall,
        "invalidIds": sorted(metrics.referenced_ids - metrics.valid_ids),
    }
