...
CONTEXT_FOLLOW_UP_HINTS = (
    "刚才", "上一个", "前面", "继续", "补充", "再说", "这个问题", "这个回答", "上述",
    "continue", "previous", "follow up",
)
CONTEXT_FOLLOW_UP_WORD_HINTS = re.compile(r"\b(?:that|it|continue|previous)\b|\bfollow[ -]+up\b")
FOLLOW_UP_SEARCH_HINTS = (
    "我允许你联网", "允许你联网", "可以联网了", "联网吧", "现在告诉我答案",
    "告诉我答案", "继续回答", "回答刚才", "回答上一个", "前面那个问题",
    "刚才那个问题", "再试一次", "重新回答",
)
...
GRAPH_SEARCH_HINTS = (
    "关系", "关联", "依赖", "上下游", "技术栈", "组成", "知识图谱", "实体", "链路",
    "relationship", "related", "dependency", "dependencies", "upstream", "downstream",
    "architecture", "tech stack", "technology stack", "entity", "knowledge graph",
)
...
TECH_SEARCH_HINTS = (
    "技术", "开发", "编程", "代码", "开源", "仓库", "数据库", "框架", "api", "sdk", "bug", "issue",
    "github", "stackoverflow", "documentation", "docs", "developer", "repository", "framework",
    "library", "api", "sdk", "implementation", "error",
)
GRAPH_QUERY_STOP_TERMS = {
    "what", "which", "where", "when", "why", "how", "please", "analyze", "analysis",
    "between", "relationship", "relationships", "related", "dependency", "dependencies",
    "upstream", "downstream", "architecture", "entity", "entities", "project", "system",
    "systems", "service", "services", "technology", "technologies", "tech", "stack",
}
MODEL_SOURCE_HINTS = (
    "项目", "知识库", "文档", "资料", "文件", "数据库", "配置", "附件",
    "project", "knowledge", "document", "file", "database", "config", "repository",
)
...
SEARCH_STOPWORDS = frozenset({
    "这", "这个", "那个", "项目", "知识库", "资料", "文档", "文件", "问题", "回答", "内容", "信息",
    "什么", "如何", "怎么", "怎样", "请", "告诉", "一个", "是否", "有没有", "根据", "里面",
    "现在", "使用", "关于", "the", "this", "that", "what", "how", "please", "tell", "about",
})
